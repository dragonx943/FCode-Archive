...
public class SinhVienView extends javax.swing.JFrame {
    ...
    public void loadDataTable() {
        _defaultTableModel = (DefaultTableModel) tblSinhVien.getModel();
    ...
    public SinhVienView() {
        initComponents();
        list = service.getAll(); //lấy ds từ service qua
        loadDataTable();
    ...
    private void clearData() {
        ...
        txtTuoi.setText("");
        txtDiaChi.setText("");
        buttonGroup1.clearSelection(); // phải gọi cả Group
    }

    private void fillData(int index) {
        SinhVien sv = list.get(index); // lấy ra đối tượng tạo ra index
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(txtTen, javax.swing.GroupLayout.PREFERRED_SIZE, 406, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                            .addComponent(jLabel2)
                            .addGap(31, 31, 31)
                            .addComponent(txtMaSV, javax.swing.GroupLayout.PREFERRED_SIZE, 406, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void tblSinhVienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSinhVienMouseClicked
        // TODO add your handling code here:
        // click chuột phải vào table -> event -> mouse -> mouse click
        int index = tblSinhVien.getSelectedRow();
        fillData(index);
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        // TODO add your handling code here:
        String a = txtMaSV.getText();
        String b = txtTen.getText(); 
        int c = Integer.parseInt(txtTuoi.getText());
        String e = txtDiaChi.getText(); 
        Boolean d = null;
        if (rdoNam.isSelected()) {
            d = true;
        } else if (rdnNu.isSelected()) {
            d = false;
        }
        
        service.them(a, b, c, d, e);
        service.getAll();
        loadDataTable();
    ...
    private void btnTimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimActionPerformed
        ...
        System.out.println(keyword); // for debug by draken!
        ArrayList<SinhVien> all = service.getAll();
        ...
        _defaultTableModel = (DefaultTableModel) tblSinhVien.getModel();
        _defaultTableModel.setRowCount(0);
        for (SinhVien listSearch1 : listSearch) {
            _defaultTableModel.addRow(new Object[]{
                listSearch1.getMaSV(),
                listSearch1.getTen(),
                listSearch1.getTuoi(),
                listSearch1.checkGender(),
                listSearch1.getDiaChi(),
            });
        }
